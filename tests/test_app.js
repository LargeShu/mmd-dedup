...
проверить('направление сортировки разворачивает список',
  поУбыванию.join('|') === поВозрастанию.slice().reverse().join('|') ||
  DATA.folders.length < 2);
